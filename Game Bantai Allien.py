...
class Game:
	...
	def start_text(self):
		...
		text = font.render('PEMBANTAIAN ALIEN', True, 'red')
		text_rect = text.get_rect(center=(s_width/2, s_height/2))
		screen.blit(text, text_rect)

		font2 = pygame.font.SysFont('Calibri', 20)
		text2 = font2.render('You Cannot Stop DK', True, 'white')
	...
	def pause_text(self):
		font = pygame.font.SysFont('Calibri', 50)
		text = font.render('Jeda Dolo Bro, Talama Mata Saki', True, 'white')
		text_rect = text.get_rect(center=(s_width/2, s_height/2))
		screen.blit(text, text_rect)
	...
	def game_over_text(self):
		font = pygame.font.SysFont('Calibri', 50)
		text = font.render('Ose Kalah Bro', True, 'red')
		text_rect = text.get_rect(center=(s_width/2, s_height/2))
		screen.blit(text, text_rect)
	...
	def create_lives(self):
		...
		for i in range(self.lives):
			screen.blit(self.live_img, (10+n, 10))
			n += 60
